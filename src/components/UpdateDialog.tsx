    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 w-[320px] rounded-2xl overflow-hidden z-[9999]"
          style={{
            ...
            {downloading ? (
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2.5 px-4 text-[13px] font-light rounded-xl transition-all duration-100 cursor-default"
                  style={{
                ...
                <button
                  ...
                  className="py-2.5 px-4 text-[13px] font-light rounded-xl transition-all duration-100 cursor-default"
                  style={{
                    border: "1px solid var(--border-color)",
